...
| 12 | `demo_render_froxel` | 0 | × (`MYE_SHOT_SKIP_FROXEL`) | **M57d** (M57c から移送。積分結果を読む者が居ない M57c で撮ると `demo_render_deferred` と tol=0 でビット一致する 2 枚目にしかならず、動いたときの切り分けができなくなる。実測済み) |
