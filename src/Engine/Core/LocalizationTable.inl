...
// M60g2: ラグドール生成器 (右クリック対象の SkinnedMesh のスケルトンから組む)
MYE_STR(Create_Ragdoll,       "Ragdoll (from Skeleton)", "ラグドール (スケルトンから)")
MYE_STR(Create_RagdollNoSkin, "Needs a Skinned Mesh with a skeleton", "スケルトン付きのスキンメッシュが必要です")
