...
struct Options {
    ...
    //   なった。ただし**生成器は既定で立てない** — 実測すると入眠が tick 395 → 241 へ
    //   早まるだけで、**substeps 16 の要求は 1 段も下がらなかった** (2 / 4 / 8 は
    //   立てても立てなくても一生眠らない)。この rig が 16 を要求している原因は
    //   隣り合う骨の食い込みではなく「床に触れながら関節に吊られている」ほうで、
    //   幾何の逃げ (この比) はやはり要る。オーサリング側で立てれば 1.0 に寄せられる、
    //   という位置づけ。
